...
const PythonPage = () => {
  return (
    <div>
      <h1 className="text-3xl font-bold tracking-tight">Python (Direct API)</h1>
      ...
      <section className="mt-8">
        ...
        <p className="mt-2 text-slate-600 dark:text-slate-400">
          Use the <code className="bg-slate-100 dark:bg-slate-800 px-2 py-1 rounded">requests</code> library to call the API:
        </p>
      ...
      <section className="mt-8">
        <h2 className="text-2xl font-semibold">FastAPI Integration</h2>
        <p className="mt-2 text-slate-600 dark:text-slate-400">
