...
const statusStyles: Record<string, string> = {
  clean: "bg-emerald-950/50 text-emerald-300 border-emerald-800",
  blocked: "bg-red-950/50 text-red-300 border-red-800",
  flagged: "bg-yellow-950/50 text-yellow-300 border-yellow-800",
  pending: "bg-blue-950/50 text-blue-300 border-blue-800",
}
